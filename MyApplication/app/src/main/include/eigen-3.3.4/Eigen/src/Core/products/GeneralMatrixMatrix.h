...
#define  LOG_TAG    "GENEARLMATRIDXMATRIX"
...
//    LOGI("frank tid %d, threads %d",tid, threads);
...
//    LOGI("frank eigen start");
    ...
    const bool pack_rhs_once = mc!=rows && kc==depth && nc==cols;
        vector<shared_future<void>> vec;
//    printf("rows %d, cols %d, mc %d, kc %d, nc %d depth %d\n", rows, cols, mc, kc, nc, depth);
